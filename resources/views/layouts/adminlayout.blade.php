    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper" style="background-color: #4e73df;">
            ...
            <div class="list-group list-group-flush" style="background-color: #4e73df;">
                ...
                <a href="/testimonial" class="list-group-item list-group-item-action text-white"><i
                        class="fa fa-user-o text-white" aria-hidden="true"></i>Add Testimonial</a>

                <a class="list-group-item list-group-item-action dropdown-toggle text-white" href="#"
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="/managetestimonial">Manage Testimonials</a>
                </div>
            </div>
        </div>
        <!-- /#sidebar-wrapper -->
